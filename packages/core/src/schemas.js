export const analysisSchema = Object.freeze({
  ...
  properties: {
    ...
    relations: {
      type: "array",
      description: "When workspace_context.domain_schema defines non-empty relationTypes, each relation must also provide localId, relationTypeId, sourceEntityLocalId, targetEntityLocalId, and properties. An empty relationTypes array leaves relations unconstrained by the domain schema.",
      items: { $ref: "#/$defs/groundedCandidate" },
      maxItems: 1000,
    },
